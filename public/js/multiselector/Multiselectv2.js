...
Ext.extend(Ext.ux.ItemSelector, Ext.form.Field, {
	...
	onRender : function(ct, position) {
		...
		this.fromMultiselect = new Ext.ux.Multiselect({legend:this.fromLegend, delimiter:this.delimiter, 
		...
		this.toMultiselect = new Ext.ux.Multiselect({legend:this.toLegend, delimiter:this.delimiter, 
