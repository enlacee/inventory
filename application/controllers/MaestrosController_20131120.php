...

{
...

    {
		...
		where maestros_mercaderias.mcd_id = ".$_POST['pro_id']."
		...
		from detalle_compras
			...
			inner join movimientos_compras on detalle_compras.mco_id = movimientos_compras.mco_id and detalle_compras.pro_id = ".$_POST['pro_id']." and age_id = ".$_POST['age_id']." and movimientos_compras.eliminado = '0' and movimientos_compras.anulado='0' and detalle_compras.afecta_stock = 'S'
		...
		from detalle_ventas
			...
			inner join movimientos_ventas on detalle_ventas.mve_id = movimientos_ventas.mve_id and detalle_ventas.pro_id = ".$_POST['pro_id']." and age_id = ".$_POST['age_id']."  and movimientos_ventas.eliminado = '0' and  movimientos_ventas.anulado='0' and detalle_ventas.afecta_stock = 'S'
		...
		from detalle_altas
			...
			inner join movimientos_altas on detalle_altas.mal_id = movimientos_altas.mal_id and detalle_altas.pro_id = ".$_POST['pro_id']." and age_id = ".$_POST['age_id']." and movimientos_altas.eliminado = '0' and movimientos_altas.anulado='0' and detalle_altas.afecta_stock = 'S'
		...
		from detalle_bajas
			...
			inner join movimientos_bajas on detalle_bajas.mba_id = movimientos_bajas.mba_id and detalle_bajas.pro_id = ".$_POST['pro_id']." and age_id = ".$_POST['age_id']."  and movimientos_bajas.eliminado = '0' and  movimientos_bajas.anulado='0' and detalle_bajas.afecta_stock = 'S'
		...
		from detalle_notacompras
			...
			inner join movimientos_notacompras on detalle_notacompras.nco_id = movimientos_notacompras.nco_id and detalle_notacompras.pro_id = ".$_POST['pro_id']." and age_id = ".$_POST['age_id']." and movimientos_notacompras.eliminado = '0' and movimientos_notacompras.anulado='0' and detalle_notacompras.afecta_stock = 'S'
		...
		from detalle_notaventas
			...
			inner join movimientos_notaventas on detalle_notaventas.nve_id = movimientos_notaventas.nve_id and detalle_notaventas.pro_id = ".$_POST['pro_id']." and age_id = ".$_POST['age_id']."  and movimientos_notaventas.eliminado = '0' and  movimientos_notaventas.anulado='0' and detalle_notaventas.afecta_stock = 'S'
		...
		from detalle_trasladoing
			...
			inner join movimientos_trasladoing on detalle_trasladoing.tin_id = movimientos_trasladoing.tin_id and detalle_trasladoing.pro_id = ".$_POST['pro_id']." and age_id = ".$_POST['age_id']."  and movimientos_trasladoing.eliminado = '0' and  movimientos_trasladoing.anulado='0' and detalle_trasladoing.afecta_stock = 'S'
		...
		from detalle_trasladoing
			...
			inner join movimientos_trasladoing on detalle_trasladoing.tin_id = movimientos_trasladoing.tin_id and detalle_trasladoing.pro_id = ".$_POST['pro_id']." and tie_des = ".$_POST['age_id']."  and movimientos_trasladoing.eliminado = '0' and  movimientos_trasladoing.anulado='0' and detalle_trasladoing.afecta_stock = 'S'
...

    {
		...
		$pdf->ezTable($db_data, $col_names, 'Listado de Tiendas', $options);
		...
		if($_POST['quitar']=='SI'){
...

			{
				...
				if($fila["tie_id"]>2){
					...
					if(!($_POST['mismo']=='NO' and $fila["tie_id"] == $_POST['se_age_id'])){
